...
- [x] `motor`: Installed and verified.
- [x] `python-jose`: Installed and verified (mapped to `jose`).
- [x] `passlib`: Installed and verified.
- [ ] `bcrypt`: Not found / import failed.
- [x] `python-multipart`: Installed and verified (mapped to `multipart`).
...
- [x] `pytest`: Installed and verified.
- [x] `httpx`: Installed and verified.
- [ ] `plotly`: Not found / import failed.
