...
class Settings(BaseSettings):
    ...
    DEFAULT_INFERENCE_MODE: str = Field(default=os.getenv('DEFAULT_INFERENCE_MODE', 'local').lower()) # 'local' or 'cloud'
    ...
    LOCAL_SIGN_RECOGNITION_MODEL_PATH: str = Field(default=os.getenv('LOCAL_SIGN_RECOGNITION_MODEL_PATH', 'models/sign_recognition_model.onnx'))
    LOCAL_TRANSLATION_MODEL_PATH: str = Field(default=os.getenv('LOCAL_TRANSLATION_MODEL_PATH', 'models/nmt_model_en_te.pt')) # Example: PyTorch model
    LOCAL_TTS_MODEL_PATH: str = Field(default=os.getenv('LOCAL_TTS_MODEL_PATH', 'models/tts_model.pth')) # Example: Coqui TTS model
