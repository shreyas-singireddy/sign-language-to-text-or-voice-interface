...
async def translate_sign(request: Request, _=Depends(get_translator), target_lang: str = Depends(get_locale_fastapi)):
    """
    ...
    translated_text, audio_file_path = ai_service.process_sign_language(video_frame_data, target_lang, inference_mode)
