...
class Evaluator:
    ...
    def evaluate_predictions(self, y_true: np.ndarray, y_pred: np.ndarray, y_prob: np.ndarray, classes: List[str]) -> Dict[str, Any]:
        """
        ...
        # Class-wise accuracy
        class_prec, class_rec, class_f1, class_supp = precision_recall_fscore_support(y_true, y_pred, labels=range(len(classes)), zero_division=0)
        class_stats = {}
