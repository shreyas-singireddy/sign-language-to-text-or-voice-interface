...
class Trainer:
    ...
    def train_model(
        ...
        val_loader = DataLoader(
            GestureDataset(X_val, y_val), batch_size=batch_size, shuffle=False, pin_memory=True
        )  # nosemgrep
        test_loader = DataLoader(
            GestureDataset(X_test, y_test), batch_size=batch_size, shuffle=False, pin_memory=True
        )  # nosemgrep
