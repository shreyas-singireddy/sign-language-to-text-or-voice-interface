...
# Page Layout Header
st.markdown('<h1 class="gradient-text" style="font-size: 3rem; margin-bottom: 5px;">VISUAL DEBUG COCKPIT</h1>', unsafe_allow_html=True)
st.markdown("<p style='font-size: 1.1rem; font-weight: bold; color: #1040C0;'>Advanced real-time human perception debugging, joint skeletal overlays, and telemetry analytics.</p>", unsafe_allow_html=True)
st.markdown("---")
