...
# Page Header
st.markdown('<h1 class="gradient-text" style="font-size: 3rem; margin-bottom: 5px;">CONFIGURATION SETTINGS</h1>', unsafe_allow_html=True)
st.markdown("<p style='font-size: 1.1rem; font-weight: bold; color: #1040C0;'>Fine-tune computer vision parameters, detection thresholds, and system preferences.</p>", unsafe_allow_html=True)
st.markdown("---")
...
with col_settings:
    ...
    # Save button
    if st.button("💾 Apply Configuration Settings", key="btn_save_settings", use_container_width=True):
...
with col_info:
    ...
    st.info("ℹ️ Information: MediaPipe parameters determine the strictness of facial and hand bone skeleton estimation. If skeletons flicker, reduce the threshold levels.")
