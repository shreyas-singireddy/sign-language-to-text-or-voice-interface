...
SOS_TRIGGER_TOKENS = {
    "SOS", "EMERGENCY", "DANGER", "FIRE", "HELP", "CALL", "POLICE",
    "AMBULANCE", "DOCTOR", "HEART", "ATTACK", "BREATHE", "BLEEDING",
    "SEIZURE", "CHEST", "PAIN", "TRAPPED", "LOST", "UNCONSCIOUS",
    "CRITICAL", "DYING", "HURT", "FALLING", "ALARM",
}
